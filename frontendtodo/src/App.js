          ...
          <div id="form-wrapper">
            <form id="form" onSubmit={this.handleSubmit}>
              <div className="flex-wrapper">
                ...
                <div style={{flex: 1}}>
                  <input className="btn btn-warning btn-md" id="submit" type="submit" value="Submit"/>
                </div>
            ...
            {tasks.map(function(task,index){
              return(
                <div key={index} className="task-wrapper flex-wrapper">
                  ...
                  <div style={{flex:1}}>
                    <button onClick={() => self.startEdit(task)} className="btn btn-sm btn-primary">Edit</button>
                  </div>
                  <div style={{flex:1}}>
